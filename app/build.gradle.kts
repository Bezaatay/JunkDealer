...
android {
    namespace = "com.kotlinegitim.myapplicationmt3"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.kotlinegitim.myapplicationmt3"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.activity:activity-ktx:1.8.1") //lifecycle
